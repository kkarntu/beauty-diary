...
import { ListTrendingTagsQuery, type ListTrendingTagsResult } from './list-trending-tags.query';

@QueryHandler(ListTrendingTagsQuery)
export class ListTrendingTagsHandler implements IQueryHandler<
  ListTrendingTagsQuery,
  ListTrendingTagsResult
> {
